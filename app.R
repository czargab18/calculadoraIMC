...
ui <- fluidPage(
  tags$head(
    tags$link(rel = "stylesheet", type = "styles/css", href = "style.css")
  ),
  div(id="content",
  h1("Calculadora de IMC"),
  div(id = "content-input",
      numericInput(inputId = "input-text-peso",
                   label = "Qual o seu peso em kilogramas?",
                   value = 60)
  ),
  div(id = "content-input",
      numericInput(inputId = "input-text-altura",
  ...
  div(id="content-resultado-ideal",
